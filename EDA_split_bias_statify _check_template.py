...
# Cell 2: Load Data and Create Initial Split
...
def create_features(data):
    ...
    if 'venda_paper_start_date' in data.columns:
        data['Venda_month'] = pd.to_datetime(data['venda_paper_start_date']).dt.month
...
X = df_analysis_featured.drop('venda', axis=1)
